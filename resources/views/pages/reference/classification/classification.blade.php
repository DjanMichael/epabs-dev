    ...
    <script>
        ...
        */
            ...
            $("#btn_search").on('click',function(){
                ...
                populateTableBySearch("{{ route('d_get_classification_search') }}", str, 'table_populate', 'table_content', 'table_pagination');
                        ...
                        success: function(result) {
                           setTimeout(function() {
                            ...
                            if (result['type'] == 'insert') {
                                ...
                                $('#modal_reference').modal('toggle');
                                $('#'+id).children('td[data-target=classification]').html(data.classification);
