    ...
    public function up()
    {
        ...
        DB2::statement('
            ...
            FROM
                ...
                LEFT JOIN tbl_unit_budget_allocation tuba ON tuba.budget_line_item_id = rbli.id
                LEFT JOIN ref_program rp ON rp.id = tuba.program_id
                LEFT JOIN ref_units ru ON ru.id = tuba.unit_id
                        ORDER BY rbli.id
            )
        ');
    }
