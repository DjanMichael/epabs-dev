...
class CreateTblProgramConapDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_program_conap_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_program_conap_details');
    }
}
