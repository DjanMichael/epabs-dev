...
{
    //
    public function index(){ return view('pages.reference.office_unit.office_unit'); }

    public function getOfficeUnit()
    {
        $data = RefUnits::paginate(10);
        return view('pages.reference.office_unit.table.display_office_unit',['officeunit'=> $data]);
    }
    ...
    public function getAddForm(){
        return view('pages.reference.office_unit.form.add_office_unit');
    }
